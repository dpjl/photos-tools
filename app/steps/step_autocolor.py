...
class AutoColorStep(StepBase):
    ...
    param_defs = [
        ...
        {"key": "wb_strength", "label": "Force WB",      "type": "float",
        ...
        {"key": "warmth",     "label": "Chaleur",         "type": "int",
         "default": 0, "min": -30, "max": 30, "step": 1},
        {"key": "red_desat",     "label": "Désat. rouges",   "type": "float",
         "default": 0.0, "min": 0.0, "max": 1.0, "step": 0.05},
        {"key": "red_threshold", "label": "Seuil sat. rouge", "type": "float",
